@echo off
REM ===========================================================================
REM  RFID Reader Service - Windows installer (wrapper)
REM
...
REM    INSTALL.bat https://valleyag.scaledata.net -SerialPort COM3
...
REM Collect any remaining switches (-SerialPort COM3, -ServiceId x, -Port n, ...).
set EXTRA=
:collect
if "%~1"=="" goto run
set EXTRA=%EXTRA% %1
